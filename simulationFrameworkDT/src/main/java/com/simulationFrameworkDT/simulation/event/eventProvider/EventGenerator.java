...
public class EventGenerator {
	...
	public Event generateAi(Date date,int headwayDesigned, long busId, long stopId){
		...
		return new SimulationEvent(true,busId,stopId, 0, arrivetDate);//create the event for arrive
	}
	...
	public Event generateSi(Date date, IDistribution si, long busId, long stopId){
		...
		return new SimulationEvent(false,busId,stopId, 0, leaveDate);//create the event for leave
	}
